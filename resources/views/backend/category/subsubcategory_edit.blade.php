                            ...
                            <form action="{{ route('subsubcategory.update') }}" method="POST">
                                            ...
                                            <select name="category_id" id="" class="form-control">
                                                ...
                                                @foreach ($category as $data)
                                                    <option value="{{ $data->id }}"
                                                        {{ $data->id == $subsubcategory->category_id ? 'selected' : '' }}>
                                        ...
                                        <div class="controls">
                                            <select name="subcategory_id" id="" class="form-control">
                                                ...
                                                @foreach ($subcategory as $data)
                                                    <option value="{{ $data->id }}"
                                                        {{ $data->id == $subsubcategory->subcategory_id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="subsubcategory_name_kh" class="form-control" id=""
                                                placeholder="" value="{{ $subsubcategory->subsubcategory_name_kh }}">
