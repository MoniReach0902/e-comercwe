 ...
 <aside class="main-sidebar">
     ...
     <section class="sidebar">
         ...
         <ul class="sidebar-menu" data-widget="tree">
             ...
             <li class="treeview treeview{{ $prefix == '/category' ? 'active' : '' }} treeview">
                 <a href="#">
                 ...
                 <ul class="treeview-menu">
                     ...
                     <li class="{{ $route == 'all.subcategory' ? 'active' : '' }}"><a
                             href="{{ route('all.subcategory') }}"><i class="ti-more"></i>Sub-Category</a>
                     </li>
                     <li class="{{ $route == 'all.subsubcategory' ? 'active' : '' }}"><a
                             href="{{ route('all.subsubcategory') }}"><i
                                 class="ti-more"></i>Sub-SubCategory</a>
                     </li>

                 </ul>
             </li>

             <li class="treeview treeview{{ $prefix == '/product' ? 'active' : '' }} treeview">
                 <a href="#">
                 ...
                 <ul class="treeview-menu">
                     ...
                     <li class="{{ $route == 'manage-product' ? 'active' : '' }}"><a
                             href="{{ route('manage-product') }}"><i class="ti-more"></i>Maange Product</a></li>
